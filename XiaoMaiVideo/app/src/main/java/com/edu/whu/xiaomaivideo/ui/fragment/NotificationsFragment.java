...
import com.edu.whu.xiaomaivideo.viewModel.CenterViewModel;
...
public class NotificationsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        centerViewModel = new ViewModelProvider(Objects.requireNonNull(getActivity())).get(CenterViewModel.class);

        fragmentNotificationsBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_notifications, container, false);
        fragmentNotificationsBinding.setViewmodel(centerViewModel);
