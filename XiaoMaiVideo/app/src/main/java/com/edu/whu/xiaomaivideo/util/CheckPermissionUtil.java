...
import static com.edu.whu.xiaomaivideo.others.BaseApplication.getContext;
...
public class CheckPermissionUtil {
    ...
    /**
     * 只用这个方法，华为手机的地理权限打开与否，不能准确判断出，需要上面的方法 isLocationPermGrantedAndOpen
    ...
    /**
     * Function:判断录音权限,兼容android6.0以下及以上系统
     *
     * 判断是是否有录音权限
     */
