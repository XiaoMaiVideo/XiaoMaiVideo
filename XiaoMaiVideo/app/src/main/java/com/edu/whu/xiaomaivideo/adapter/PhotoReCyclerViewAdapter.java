...
import com.edu.whu.xiaomaivideo.Tools.CommonTools;
import com.edu.whu.xiaomaivideo.Tools.Config;
import com.edu.whu.xiaomaivideo.model.Video;
import com.edu.whu.xiaomaivideo.model.VideoInfo;
...
public class PhotoReCyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<VideoInfo> mShopInfoList;

    private List<Video> VideoListNine;

    public PhotoReCyclerViewAdapter(LayoutInflater mLayoutInflater, List<VideoInfo> mShopInfoList) {
    ...
    public int getItemViewType(int position) {
        switch (mShopInfoList.get(position).getVideoList().size()) {
            case 1:
                return PIC_ONE;
            case 4:
                return PIC_FOUR;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OneImageViewHolder) {
            final List<Video> imageListJustOne = mShopInfoList.get(position).getVideoList();
            ...
            List<Video> imageListFour = mShopInfoList.get(position).getVideoList();
            ...
            List<Video> imageListNine = mShopInfoList.get(position).getVideoList();
    ...
    public void startZoomInImageActivityOne(final List<Video> imageList, final int clickNum, final ImageView imageview) {
    ...
    public void startZoomInImageActivity(final List<Video> imageList, final int clickNum, final ImageView imageview) {
        imageview.setOnClickListener(new View.OnClickListener() {
            @TargetApi(Build.VERSION_CODES.LOLLIPOP)
            @Override
            public void onClick(View v) {
